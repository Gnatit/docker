...
docker network connect outside  --alias tomcat.mellon.sp.fr  --alias mellon.sp.fr mellon

```

Also use -v hostDirectory:containerDirectory to share metadata

https://github.com/UNINETT/mod_auth_mellon/issues/94
